...
import { PillIcon, CameraIcon, LoadingSpinner, UploadIcon } from './components/Icons';
    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          ...
          <span className="text-xs text-slate-400 bg-teal-50 text-teal-700 px-2 py-1 rounded-full font-medium">
            Pill Detector (Local AI)
          </span>
        </div>
      </header>
